...
// Clear the time area
  ...
  Serial.println(dayRTC);
  Serial.println(monthRTC);
  Serial.println(yearRTC);
...
if((d5 != c5)||(xsetup == true)){
  myGLCD.printNumI(d5,215,105); // Was 205  
}

if((d6 != c6)||(xsetup == true)){
  myGLCD.printNumI(d6,230,105); // Was 205  
}

//Fecha
myGLCD.printNumI(dayRTC,65,150);
//myGLCD.print(daysOfTheWeek[dayOfWeek()],100,100);

myGLCD.print(monthsNames[monthRTC],85,150);
myGLCD.printNumI(yearRTC,200,150);
